...
public class ScheduleCommerceResourceIntTest {
    ...
    public void createScheduleCommerce() throws Exception {
        ...
        assertThat(testScheduleCommerce.getClosingTime()).isEqualTo(DEFAULT_CLOSING_TIME);
    }
    ...
    public void updateScheduleCommerce() throws Exception {
        ...
        assertThat(testScheduleCommerce.getClosingTime()).isEqualTo(UPDATED_CLOSING_TIME);
    }
